  ...
  return {
    ...
    async loadData() {
      ...
      try {
        ...
        this.loadError = e.message || '无法加载通信数据。';
      }
      this.loading = false;
    },
    ...
    async submitSend() {
      ...
      try {
        ...
        OpenFangToast.success('消息已发送');
        this.showSendModal = false;
      } catch(e) {
        OpenFangToast.error(e.message || '发送失败');
      }
    ...
    async submitTask() {
      ...
      try {
        ...
        OpenFangToast.success('任务已发布');
        this.showTaskModal = false;
      } catch(e) {
        OpenFangToast.error(e.message || '任务失败');
      }
